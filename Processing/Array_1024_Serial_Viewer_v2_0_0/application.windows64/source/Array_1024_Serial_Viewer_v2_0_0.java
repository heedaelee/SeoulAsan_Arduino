...
public class Array_1024_Serial_Viewer_v2_0_0 extends PApplet {
...
public void draw() {
  ...
  text("FPS :"+PApplet.parseInt(frameRate), 20, 60);
...
public int byte2int(byte msb, byte lsb) { //[4],[3] because c++ have Little endian, byte is reversed. in arduino, (byte*)data
...
public String timeStamp(int MS) {
  float seconds = PApplet.parseFloat(nfs((MS % 60000)/1000f, 2, 2));
...
public int remap(int val) {
  float v = map(val, 0, 2000, 0, 100);
  return (int)v;
}
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "Array_1024_Serial_Viewer_v2_0_0" };
    if (passedArgs != null) {
